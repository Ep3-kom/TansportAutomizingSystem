...
- [ ] **Backup & disaster recovery plan documenteren** — Supabase doet backups, maar herstelproces moet bekend zijn.# Deployment

Onderdeel van: [[TAS Home]]
Gerelateerd: [[Tech Stack]] · [[Supabase Setup]]
...
- **Auto-deploy:** Ja, via GitHub integratie
- **HTTPS:** Automatisch via Vercel
- **Domein:** https://transportautomizingsystem.nl/
...
Volledig serverless. Geen eigen server nodig.
...
```
GitHub Push → Vercel Auto-Build → Preview/Production Deploy
```

- **Preview deploys:** Automatisch voor elke PR
- **Production deploy:** Automatisch bij push naar `main`

## Wat ontbreekt

- [ ] Staging environment (nu direct naar productie)
- [ ] Health check monitoring
- [ ] Uptime monitoring (bijv. BetterUptime)
- [ ] Error tracking — zie [[Launch Checklist]]
